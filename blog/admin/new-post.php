...
<div class="container">
    <div class="row">
      ...
      <!-- <form action="admin.php" method="post" enctype="multipart/form-data"> -->
        ...
        <form action="new-post.php" method="post" enctype="multipart/form-data">
          ...
          <p class="subtitle">Imágen de portada</p>
          <?php if (!empty($msg)): ?>
  ...
  <div style="display: none;" class="form-group">
    <input required  id="content"  type="text" name="content" class="form-control" placeholder="Enter title here">
  </div>
  ...
  <button style="cursor: pointer;" data-func="clear" type="button">Limpiar</button>
